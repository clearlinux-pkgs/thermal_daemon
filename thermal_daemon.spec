...
%package doc
Summary: doc components for the thermal_daemon package.
Group: Documentation

%description doc
doc components for the thermal_daemon package.


%prep
%setup -q -n thermal_daemon-1.7.1
%patch1 -p1
