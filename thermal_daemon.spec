...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612365213
...
cp %{_builddir}/thermal_daemon-2.4.2/COPYING %{buildroot}/usr/share/package-licenses/thermal_daemon/b3aebbdebf056cbf1cb73b76edf8ea105c37239d
cp %{_builddir}/thermal_daemon-2.4.2/tools/thermal_monitor/qcustomplot/GPL.txt %{buildroot}/usr/share/package-licenses/thermal_daemon/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
