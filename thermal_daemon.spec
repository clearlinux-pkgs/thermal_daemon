...
Source0  : https://github.com/intel/thermal_daemon/archive/v1.9.1.tar.gz
...
%prep
%setup -q -n thermal_daemon-1.9.1
cd %{_builddir}/thermal_daemon-1.9.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576669061
