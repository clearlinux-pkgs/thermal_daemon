...
Source0  : https://github.com/intel/thermal_daemon/archive/v2.4.9/thermal_daemon-2.4.9.tar.gz
...
%prep
%setup -q -n thermal_daemon-2.4.9
cd %{_builddir}/thermal_daemon-2.4.9
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647646301
...
cp %{_builddir}/thermal_daemon-2.4.9/COPYING %{buildroot}/usr/share/package-licenses/thermal_daemon/b3aebbdebf056cbf1cb73b76edf8ea105c37239d
%make_install
