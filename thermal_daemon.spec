...
Source0  : https://github.com/intel/thermal_daemon/archive/v2.4/thermal_daemon-2.4.tar.gz
...
%prep
%setup -q -n thermal_daemon-2.4
cd %{_builddir}/thermal_daemon-2.4
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606347743
...
cp %{_builddir}/thermal_daemon-2.4/COPYING %{buildroot}/usr/share/package-licenses/thermal_daemon/b3aebbdebf056cbf1cb73b76edf8ea105c37239d
cp %{_builddir}/thermal_daemon-2.4/tools/thermal_monitor/qcustomplot/GPL.txt %{buildroot}/usr/share/package-licenses/thermal_daemon/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
