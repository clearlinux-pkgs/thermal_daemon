...
Version  : 2.2
Release  : 30
URL      : https://github.com/intel/thermal_daemon/archive/v2.2/thermal_daemon-2.2.tar.gz
Source0  : https://github.com/intel/thermal_daemon/archive/v2.2/thermal_daemon-2.2.tar.gz
...
%prep
%setup -q -n thermal_daemon-2.2
cd %{_builddir}/thermal_daemon-2.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595290856
...
cp %{_builddir}/thermal_daemon-2.2/COPYING %{buildroot}/usr/share/package-licenses/thermal_daemon/b3aebbdebf056cbf1cb73b76edf8ea105c37239d
cp %{_builddir}/thermal_daemon-2.2/tools/thermal_monitor/qcustomplot/GPL.txt %{buildroot}/usr/share/package-licenses/thermal_daemon/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
