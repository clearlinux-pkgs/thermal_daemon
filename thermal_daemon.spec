...
Source0  : https://github.com/intel/thermal_daemon/archive/v2.5.2/thermal_daemon-2.5.2.tar.gz
...
%prep
%setup -q -n thermal_daemon-2.5.2
cd %{_builddir}/thermal_daemon-2.5.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675186562
