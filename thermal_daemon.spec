...
Source0  : https://github.com/intel/thermal_daemon/archive/v2.5.8/thermal_daemon-2.5.8.tar.gz
...
%prep
%setup -q -n thermal_daemon-2.5.8
cd %{_builddir}/thermal_daemon-2.5.8
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a thermal_daemon-2.5.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723731042
