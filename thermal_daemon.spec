...
Version  : 2.5.5
Release  : 54
URL      : https://github.com/intel/thermal_daemon/archive/v2.5.5/thermal_daemon-2.5.5.tar.gz
Source0  : https://github.com/intel/thermal_daemon/archive/v2.5.5/thermal_daemon-2.5.5.tar.gz
...
%prep
%setup -q -n thermal_daemon-2.5.5
cd %{_builddir}/thermal_daemon-2.5.5
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a thermal_daemon-2.5.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705940032
