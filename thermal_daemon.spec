...
%prep
%setup -q -n thermal_daemon-2.4.6
cd %{_builddir}/thermal_daemon-2.4.6
%patch1 -p1
%patch2 -p1
...
cp %{_builddir}/thermal_daemon-2.4.6/tools/thermal_monitor/qcustomplot/GPL.txt %{buildroot}/usr/share/package-licenses/thermal_daemon/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
